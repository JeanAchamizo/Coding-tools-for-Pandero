...
carpeta_imagenes = r"C:\Users\jachamizo\Pictures\Reporte de ventas\2025-06-03"  # Ruta absoluta
...
mensaje_inicial = f"Buenos días a todos, se comparte el ranking de ventas por equipo hasta el cierre de ayer {fecha_ayer}"
